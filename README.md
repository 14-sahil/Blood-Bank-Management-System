...
3. Download project from github(https://github.com/suraj1849/Blood-Bank-Management-System.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/suraj1849/Blood-Bank-Management-System-System.git
