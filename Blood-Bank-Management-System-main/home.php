  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="image\ban2.jpg" alt="image\ban2.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\ban3.jpg" alt="image\ban2.jpg" width="100%" height="500">
      </div>
...
<br>
        ...
        <div class="row">
          <?php
            ...
            while($row = mysqli_fetch_assoc($result)) {
           ?>
            <div class="col-lg-3 col-sm-5 portfolio-item" ><br>
            <div class="card" style="width:250px">
                <img class="card-img-top" src="image\blood_drop_logo.jpg" alt="Card image" style="width:89%;height:200px">
                <div class="card-body">
